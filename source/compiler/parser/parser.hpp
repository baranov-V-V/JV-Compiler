...
/**
 ** \file /home/viktor/repos/MiniCompiler/source/compiler/parser/parser.hpp
...
#ifndef YY_YY_HOME_VIKTOR_REPOS_MINICOMPILER_SOURCE_COMPILER_PARSER_PARSER_HPP_INCLUDED
# define YY_YY_HOME_VIKTOR_REPOS_MINICOMPILER_SOURCE_COMPILER_PARSER_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 9 "/home/viktor/repos/MiniCompiler/source/compiler/parser/parser.y"
...
#line 57 "/home/viktor/repos/MiniCompiler/source/compiler/parser/parser.hpp"
...
namespace yy {
#line 191 "/home/viktor/repos/MiniCompiler/source/compiler/parser/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      char dummy2[sizeof (LocalVariableStatement*)];
      ...
      // statement_list
      char dummy6[sizeof (StatementList*)];

      // variable_declaration
      char dummy7[sizeof (VariableDeclaration*)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, LocalVariableStatement*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const LocalVariableStatement*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_PLUS || tok == token::TOK_MINUS || tok == token::TOK_MUL || tok == token::TOK_DIV || tok == token::TOK_EQUAL || tok == token::TOK_NEQUAL || tok == token::TOK_LESS || tok == token::TOK_GREATER || tok == token::TOK_OR || tok == token::TOK_AND || tok == token::TOK_PERCENT || tok == token::TOK_NUMBER);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_MUL (int v, location_type l)
      {
      ...
      static
      symbol_type
      make_DIV (int v, location_type l)
      {
      ...
      static
      symbol_type
      make_NEQUAL (int v, location_type l)
      {
        return symbol_type (token::TOK_NEQUAL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_NEQUAL (const int& v, const location_type& l)
      {
        return symbol_type (token::TOK_NEQUAL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_PERCENT (int v, location_type l)
      {
      ...
      static
      symbol_type
      make_PERCENT (const int& v, const location_type& l)
      {
...
#line 2189 "/home/viktor/repos/MiniCompiler/source/compiler/parser/parser.hpp"





#endif // !YY_YY_HOME_VIKTOR_REPOS_MINICOMPILER_SOURCE_COMPILER_PARSER_PARSER_HPP_INCLUDED
